                                ...
                                <div className="pThmb">
                                    ...
                                    <div className="iFxd">
                                        ...
                                        {item.comments.length > 0 ?
                                            <Link aria-label="Comments" className="cmnt" data-text={item.comments.length + item.comments.reduce((acc, comment) => acc + (comment.replies ? comment.replies.length : 0), 0)} href={"/p/" + item.url + "#comments"} role="button">
