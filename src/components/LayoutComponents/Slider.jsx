function Slider(){
    return(
        <div className="sldO scrlH section" id="slider-widget">
                    <div className="widget Image" data-version={2} id="Image1">
                    ...
                    <div className="widget Image" data-version={2} id="Image3">
                      <div className="sldC" id="Image3_img">
                        <div
                          className="sldIm lazy loaded"
                          data-style="background-image: url(https://1.bp.blogspot.com/-vK7BQxXeYnk/YF1Q9MVgZ8I/AAAAAAAAQls/OanP_Tl4sd4616Y1RaD2JPA_UOWtMkDAQCNcBGAsYHQ/s0/slider-3-min.png)"
                          lazied="true"
                          style={{
                            backgroundImage:
                    ...
                    <div className="widget Image" data-version={2} id="Image4">
                      <div className="sldC" id="Image4_img">
                        <div
                          className="sldIm lazy loaded"
                          data-style="background-image: url(https://1.bp.blogspot.com/-Q_BGkGuukLE/YF1Q67reH4I/AAAAAAAAQlk/jXe6LIyIjkkNpJu7ShtztoUWV4JylmCkgCNcBGAsYHQ/s0/slider-4-min.png)"
                          lazied="true"
                          style={{
                            backgroundImage:
