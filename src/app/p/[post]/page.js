...
import Like from "@/app/components/LayoutComponents/Like";
import Link from "next/link";
import { api, date,domain } from "@/app/Contexts";
import Notification from "@/app/components/LayoutComponents/Notification";
import Sidebar from "@/app/components/LayoutComponents/Sidebar";
import Mobilemenu from "@/app/components/LayoutComponents/Mobilemenu";
import Footer from "@/app/components/LayoutComponents/Footer";
import { Pshare, Share } from "@/app/components/LayoutComponents/Pshare";
import Pcomment from "@/app/components/LayoutComponents/Pcomment";


 
async function getPostData(post) {
  const res = await fetch(`${api}p/${post}`)
  return res.json()
}
...
const url = `${domain}/p/${postcontent.url}`
  return <>
