    ...
    <>
      <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column" }}>
        ...
        <input
          ...
          className={`${errors.name && touched.name && "border-red-500"} ${formStyles.authInput
            }`}
        ...
        <input
          ...
          className={`${errors.email && touched.email && "border-red-500"} ${formStyles.authInput
            }`}
        />
        ...
        <div className={formStyles.passwordField}>
          ...
          <span
            ...
            className={formStyles.authEyeBtn}
          >
            {show ? (
